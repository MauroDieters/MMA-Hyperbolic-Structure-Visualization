...
# Sklearn t-SNE modified for hyperbolic embeddings. Uses the flow from the "exact" method version
# and precomputed distances (method='exact', metric='precomputed')
...
class TSNE(BaseEstimator):
    ...
    def _fit(self, X, embs, skip_num_points=0):
        ...
        if isinstance(self.init, np.ndarray):
            ...
            # X_embedded = (th.rand(n_samples, self.n_components) - 0.5) * 0.05 
            # X_embedded = pmath.expmap0(X_embedded, c=1).numpy()
    ...
    def _tsne(self, P, degrees_of_freedom, n_samples, X_embedded, embs,
        ...
        # opt_args['momentum'] = 0
        # opt_args['n_iter_without_progress'] = self.n_iter_without_progress
        # params, kl_divergence, it, errors3, outs3, splits3, grads3, grads_per3, grad_signs3 = _gradient_descent(obj_func, params,
        #                                               **opt_args)
